...
ActiveRecord::Schema.define(version: 20170301132759) do
  ...
  create_table "meals", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.integer  "meal_availability_id"
    t.index ["meal_availability_id"], name: "index_meals_on_meal_availability_id", using: :btree
